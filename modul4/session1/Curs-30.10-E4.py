angajat1 = {'nume': 'Ana-Maria Popescu',
            'departament': 'IT',
            'ID': 3409,
            'Salar': 4560}
angajat2 = {'nume': 'Marian Muntean',
            'departament': 'IT',
            'ID': 2235,
            'Salar': 4556,}
angajat3 = {'nume': 'Maria Manea',
            'departament': 'HR',
            'ID': 1908,
            'Salar': 6755,}
angajat4 = {'nume': 'Oana Popa',
            'departament': 'HR',
            'ID': 1977,
            'Salar': 5400,}
angajat5 = {'nume': 'David Codru',
...
def shows_hr_pay_average(user_data: list):
    all_pay = []
    for user in user_data:
        user: dict
